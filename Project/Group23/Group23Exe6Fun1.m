function [R2,adjR2] = Group23Exe6Fun1(index,Country,limits)
    % Eleni Kalla 9398
    % Iordanis Konstantinidis 9492
    
    % Multiple linear regression with cases as indepedent variables: 
    % x(t),x(t-1),x(t-2),...,x(t-20) and deaths as depedent variable: y(t)
