 function [ mse ] = Group23Exe1Fun2(index, CasesOrDeaths, Distribution)
    
    % Eleni Kalla 9398
    % Iordanis Konstantinidis 9492
    
    % The purpose of this function is to:
    % 1. Normalize the samples of cases and deaths
    ...
    % 4. Display figures that are handled by the input 'index' with info
